...
namespace Luadicrous.Framework
{
	...
	{
		private T _Root;
		public Action<T> RootChanged { get; set; }
		public T Root
		{
			get { return _Root; }
			private set
		...
		private T _Parent;
		public Action<T> AncestorChanged { get; set; }
		public Action<T> ParentChanged { get; set; }
		public T Parent
		{
			get { return _Parent; }
			set
		...
		public Action<T> DecendentAdded { get; set; }
		public Action<T> ChildAdded { get; set; }
        public virtual T AddChildren(params T[] children)
		{
		...
		public Action<T> DecendentRemoved { get; set; }
		public Action<T> ChildRemoved { get; set; }
        public virtual T RemoveChildren(params T[] children)
		{
			foreach (var child in children)
			{
				child.Parent = null;
